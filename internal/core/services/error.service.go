...
type NotAllowedContestTypeError struct {
	ContestType string
}

func (e NotAllowedContestTypeError) Error() string {
	return fmt.Sprintf("Provided not allowed contests type: %s", e.ContestType)
}
